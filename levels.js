...
function levels(level){
	...
	if(level === 17){
		blocks.kill();
		game.add.text(187, 200, "Beware of the lava!", { fill: '#c0392b', align: 'center', font:'64px Arial' });
	...
	if(level === 22){
		game.add.text(187, 200, "Don't touch the laser!", { fontSize: '32px', fill: '#c0392b', font:'64px Arial' });
		blocks.kill();
