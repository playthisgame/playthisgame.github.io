...
function levels(level){
	...
	if(level === 27){
		...
		blocks = boxes.create(400, game.world.height - 125, 'block2');
		blocks = boxes.create(400, game.world.height - 150, 'block2');
		lazer = boxes.create(300, game.world.height - 230, 'lazer');
		lazer = boxes.create(325, game.world.height - 230, 'lazer');
		lazer = boxes.create(350, game.world.height - 230, 'lazer');
		lazer = boxes.create(375, game.world.height - 230, 'lazer');
		lazer = boxes.create(400, game.world.height - 230, 'lazer');
	}
	if(level > 27){
		blocks.kill();	
	}					
