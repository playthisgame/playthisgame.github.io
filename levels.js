...
function levels(level){
	...
	if(level === 29){
		...
		lava = boxes.create(350, game.world.height - 125, 'lava');
		blocks = boxes.create(375, game.world.height - 125, 'block2');
		lazer = boxes.create(250, game.world.height - 175, 'lazer');
		lazer = boxes.create(275, game.world.height - 175, 'lazer');
		lazer = boxes.create(300, game.world.height - 175, 'lazer');
		lazer = boxes.create(325, game.world.height - 175, 'lazer');
		lazer = boxes.create(350, game.world.height - 175, 'lazer');
	}
	if(level > 29){
		blocks.kill();	
	}					
