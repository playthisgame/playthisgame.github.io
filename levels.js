...
function levels(level){
	...
	if(level == 1){
		game.add.text(game.world.centerX, 200, "Blockenstein", { fill: '#FFFFFF', text-align:center });
	...
	if(level === 22){
		game.add.text(game.world.centerX, 200, "Don't touch the laser!", { fontSize: '32px', fill: '#c0392b', align: 'center' });
		blocks.kill();
