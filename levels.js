...
function levels(level){
	...
	if(level == 1){
		game.add.text(16, 80, "Blockenstein", { fill: '#FFFFFF', font: '64px VT323',});
	...
	if(level === 57){
		...
		blocks = boxes.create(675, game.world.height - 150, 'turquoise');
		blocks = boxes.create(675, game.world.height - 175, 'turquoise');
	}
	if(level === 58){
		blocks = boxes.create(200, game.world.height - 125, 'turquoise');
		blocks = boxes.create(200, game.world.height - 150, 'turquoise');
